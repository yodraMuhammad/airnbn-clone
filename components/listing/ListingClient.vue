...
<!-- Mobile -->
<div class="max-w-screen-xl mx-auto md:hidden">
        <!-- login -->
        <div class="modal" v-if="show">
            <div class="bg-white rounded-lg shadow relative dark:bg-gray-700 w-[450px]">
                <div class="flex justify-end p-2">
    ...
    <!-- end -->
        ...
        <div class="flex flex-col gap-1">
            <div class="flex flex-col gap-10">
                <div class="w-full h-[50vh] overflow-hidden rounded-xl relative flex gap-2 z-0">
                    <Swiper class="h-full w-full"
                        :modules="[SwiperAutoplay, SwiperEffectCreative, SwiperPagination, SwiperNavigation, SwiperThumbs,SwiperHashNavigation]"
                        watch-slides-progress
                        @swiper="setThumbsSwiper"
                ...
                <div class="w-full">
                    <div class="p-4 rounded-lg border-[1px] border-black/[0.1] shadow-md flex-col gap-4 top-0 right-0 md:flex hidden">
                        <div class="flex flex-col">
                            <div class="text-xl font-bold">
                                Set amount and notes
                            </div>
